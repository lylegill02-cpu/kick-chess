...
KICK CHESS is the kickboxing variation of the hybrid training system — sparring rounds linked to chess decisions. Ring performance creates advantage or disadvantage in the mental game.
...
- [Roll Chess](https://lylegill02-cpu.github.io/roll-chess/) — BJJ variation (mat → board)
